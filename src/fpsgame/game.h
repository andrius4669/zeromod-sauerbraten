...
enum
{
    ...
    N_EDITMODE, N_EDITENT, N_EDITF, N_EDITT, N_EDITM, N_FLIP, N_COPY, N_PASTE, N_ROTATE, N_REPLACE, N_DELCUBE, N_REMIP,
#ifndef OLDPROTO
    N_EDITVSLOT, N_UNDO, N_REDO,
#endif
    N_NEWMAP, N_GETMAP, N_SENDMAP, N_CLIPBOARD, N_EDITVAR,
...
static const int msgsizes[] =               // size inclusive message token, 0 for variable or not-checked sizes
{
    ...
    N_EDITMODE, 2, N_EDITENT, 11, N_EDITF, 16, N_EDITT, 16, N_EDITM, 16, N_FLIP, 14, N_COPY, 14, N_PASTE, 14, N_ROTATE, 15, N_REPLACE, 17, N_DELCUBE, 14, N_REMIP, 1,
#ifndef OLDPROTO
    N_EDITVSLOT, 16, N_UNDO, 0, N_REDO, 0,
#endif
    N_NEWMAP, 2, N_GETMAP, 1, N_SENDMAP, 0, N_EDITVAR, 0,
    ...
    N_LISTDEMOS, 1, N_SENDDEMOLIST, 0,
#ifndef OLDPROTO
    N_GETDEMO, 3,
#else
    N_GETDEMO, 2,
